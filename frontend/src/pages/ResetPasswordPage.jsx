        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button type="submit" className="btn btn-primary w-full" disabled={isLoggingIn}>
              {isLoggingIn ? <Loader2 className="h-5 w-5 animate-spin" /> : "Set New Password"}
            </button>
          </form>
        </div>
      </div>
      <AuthImagePattern title="Secure your account" subtitle="Update your password to keep your account safe." />
    </div>
  );
};
